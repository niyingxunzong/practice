...
public class ParentAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition,
        ...
        childs.add(child);
        final ChildAdapter childAdapter = new ChildAdapter(this.mContext, childs);
        ...
        eListView.setOnGroupCollapseListener(new OnGroupCollapseListener() {
            ...
            public void onGroupCollapse(int groupPosition) {
                ...
                LayoutParams lp = new LayoutParams(
                        ViewGroup.LayoutParams.MATCH_PARENT, (int) mContext.getResources().getDimension(R.dimen.parent_expandable_list_height));
                eListView.setLayoutParams(lp);
            }
        });
        return eListView;
    ...
    /**
     * @author 点击子ExpandableListView子项的回调接口
     */
